                   ...
                   <div className="row">
                       <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                           <div className="caption pro-sl-hd">
                               <span className="caption-subject text-uppercase"><b>Membership Benefits and Cash Backs</b></span>
                           </div>
                       </div>
                   </div>
               </div>
                                 ...
                                 <tbody>
                                     {
                                         ...
                                         value.data.map((e, i)=>(
                                            ...
                                            <tr key={j+''+i}>
                                                <td>{i+1}</td>
                                                <td>{(i+1)==1?`${i+1}st`:(i+1)==2?`${i+1}nd`:(i+1)==3?`3rd`:`${i+1}th`}</td>
                                                <td>{`${e.cashback}%`}</td>
                                            </tr>
                                           </>
                                         ))  
